  ...
  return (
    <main className='p-3 max-w-4xl mx-auto' >
        ...
        <div className='flex flex-col gap-4 flex-1'>
         ...
         <textarea type="text" id='description' placeholder='Description' className='border p-3 rounded-lg'  required onChange={handleChange} value={formData.description} />
         ...
         {formData.offer &&(
              <div className='flex items-center gap-2'>
              <input type="number" id="discountedPrice" min='0' max='10000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} value={formData.discountedPrice} />
              <div className="flex flex-col items-center">
