    ...
    <div>
      {/* top */}
       <div className=' flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-slate-400 text-xs sm:text'>
          Saumya Estate is the best place to find your next perfect place to live.
          <br/>
          We have a wide range of properties to choose from, including apartments, houses, and villas.
        </div>
